                              ...
                              <body onload="ejecutar()">
                                   <script>
                                        function ejecutar() {
                                             ...
                                             if (texto == 1) {
                                                  document.getElementById('up').innerHTML = '<input name="cargo" type="hidden" value="administrador" class="form-control" required>';
                                             } else if (texto == 2) {
                                                  document.getElementById('up').innerHTML = '<input name="cargo" type="hidden" value="analista" class="form-control" required>';
                                             } else if (texto == 3) {
                                                  document.getElementById('up').innerHTML = '<input name="cargo" type="hidden" value="operador" class="form-control" required>';
                                             } else {
                                                  document.getElementById('up').innerHTML = '<input name="cargo" type="hidden" value="Gestion humana" class="form-control" required>';
                                             }
