                    ...
                    <div class="card-body">
                        <div>
                            ...
                            function entrada() {
                                ...
                                var hoy = new Date();
                                var hora = addZero(hoy.getHours()) + ":" + addZero(hoy.getMinutes()) + ":" + addZero(hoy
                                    .getSeconds());
                            ...
                            function diferencia() {
                                ...
                                window.location.href = window.location.href + "?inicio=" + inicio + "&fin=" + fin +
                                    "&name=" + nombre + "&motivo=" + motivo;
                            ...
                            function countChars(obj) {
                                ...
                                if (strLength > maxLength) {
                                    document.getElementById("charNum").innerHTML = '<span style="color: red;">' +
                                        strLength + ' de ' + maxLength + ' Carácteres Maximo</span>';
                                } else {
                            ...
                            <div class="form-group ">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <button type="button" class="btn btn-primary" id="botonentrada"
                                            onclick="entrada()">REGISTRAR HORA</button>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <input type="text" name="final" value="<?php if (isset($phpVar2)) {
                                            ...
                                            id="HoraSalida" readonly>
                                    </div>
                                    <div class="col">
                                        <button type="button" class="btn btn-primary" id="botonsalida"
                                            onclick="salida()">REGISTRAR HORA</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea onkeyup="countChars(this);" id="textarea" name="observacion" rows="6"
                                    cols="55" maxlength="500" placeholder="Escriba la Observacion"></textarea>
                            </div>
